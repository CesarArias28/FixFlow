                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="row mb-4">
                                    <div className="col-6">
                                        ...
                                        >
                                            <option value="1">Test User 1 (tenant_id: 1)</option>
                                            <option value="2">Test User 2 (tenant_id: 2)</option>
                                            <option value="3">Test User 3 (tenant_id: 3)</option>
                                        </select>
                                    </div>
                                    <div className="col-6">
                                        ...
                                        >
                                            <option value="1">Calle Falsa 123 (property_id: 1)</option>
                                        </select>
                                    </div>
                                </div>
